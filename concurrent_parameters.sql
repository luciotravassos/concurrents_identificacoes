/* Formatted on 2004/11/10 00:01 (Formatter Plus v4.7.0) */
SELECT   icon_name, user_concurrent_program_name, enabled_flag,
   ...
   WHERE queue_control_flag = 'N'
     AND (     (user_concurrent_program_name) like 
                                  '%Relatório de Acompanhamento Financeiro de Contratos%'
         )
