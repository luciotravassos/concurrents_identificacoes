/* BUSCA PELO PROGRAM LONG NAME PARA ACHAR O NOME DO PROGRAMA QUE ESTÁ EM EXECUÇÃO */
SELECT DISTINCT fcpt.user_concurrent_program_name program,
          ...
          WHERE fa.application_id = fcpt.application_id
            ...
            AND fcpt.user_concurrent_program_name LIKE 'DQM Serial Sync Index Program%'
